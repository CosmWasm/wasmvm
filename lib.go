...
func (w *Wasmer) Instantiate(contract ContractID, params []byte, userMsg []byte, storage StorageCallback, gasLimit int64) (res []byte, gasUsed int64, err error) {
	return nil, 0, nil
}
...
func (w *Wasmer) Handle(contract ContractID, params []byte, userMsg []byte, storage StorageCallback, gasLimit int64) (res []byte, gasUsed int64, err error) {
	return nil, 0, nil
}
