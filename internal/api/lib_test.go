...
func TestInstantiate(t *testing.T) {
	...
	assert.Equal(t, uint64(0xc3ae51), cost.UsedInternally)
...
func TestMultipleInstances(t *testing.T) {
	...
	assert.Equal(t, uint64(0xc27211), cost.UsedInternally)
	...
	require.NoError(t, err)
	requireOkResponse(t, res, 0)
	assert.Equal(t, uint64(0xc325c1), cost.UsedInternally)
