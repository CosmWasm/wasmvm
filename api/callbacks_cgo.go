...
// imports (querier)
GoResult cQueryExternal(querier_t *ptr, gas_meter_t *gas_meter, uint64_t *used_gas, Buffer request, Buffer *result);
...
GoResult cQueryExternal_cgo(querier_t *ptr, gas_meter_t *gas_meter, uint64_t *used_gas, Buffer request, Buffer *result) {
    return cQueryExternal(ptr, gas_meter, used_gas, request, result);
}
*/
import "C"
